...
# ============================================================
# 📡 רדאר איתור מוקדם — שלב 1: מנוע סריקה (Cluster Buying)
#                       שלב 2: אימות רב-גורמי
# ============================================================
...
# ---------- טקסטים לחלוניות ההסבר (ⓘ) ----------

RADAR_HELP = {
    "main": (
        "איך הרדאר עובד?\n\n"
        "סריקה של כל השוק האמריקאי בשלושה שלבים:\n\n"
        "1 - נסרקו: חברות שבהן 2+ מנהלים קנו מניות של החברה שלהם בכסף פרטי "
        "ב-30 הימים האחרונים (50K$+ לעסקה).\n\n"
        "2 - נבדקו: נבדקו מול שלושה פילטרים: שווי שוק עד 5B$ | PEG עד 1.5 | נפח חריג.\n\n"
        "3 - ברדאר: רק מי שעברה את כל הבדיקות. ברוב הימים הרדאר ריק - הוא בכוונה קפדני.\n\n"
        "מקורות: OpenInsider + Yahoo Finance | לא ייעוץ פיננסי"
    ),
    "volume_toggle": (
        "מתג דולק - רק חברות שגם נפח המסחר בהן קפץ (פי 1.5 מהממוצע). איתות בשל, נדיר.\n\n"
        "מתג כבוי - גם חברות שהשוק עוד לא שם לב אליהן. יותר תוצאות."
    ),
    "finalists": (
        "מנהלים קנו - כמה אנשי פנים שונים רכשו ובכמה כסף.\n\n"
        "שווי שוק - גודל החברה. עד 5B$ = קטנה/בינונית.\n\n"
        "PEG - מחיר ביחס לצמיחה. עד 1.5 = תמחור הוגן.\n\n"
        "נפח קופץ - נפח המסחר עלה מעל הממוצע."
    ),
    "rejected": (
        "השוק עוד ישן - עברה הכול חוץ מנפח. המנהלים קנו, השוק לא שם לב. "
        "כיבוי המתג למעלה יציג אותן.\n\n"
        "מניה יקרה - PEG מעל 1.5.\n\n"
        "חברה גדולה מדי - שווי שוק מעל 5B$.\n\n"
        "אין נתון PEG - אין כיסוי אנליסטים."
    ),
}
